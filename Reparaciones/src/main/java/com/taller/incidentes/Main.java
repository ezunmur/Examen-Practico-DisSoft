...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Incidente incidente1 = new Incidente("1", "MOTOR", "Ruido extrano en el motor", false);
        Incidente incidente2 = new Incidente("2", "ELECTRICO", "Falla en el sistema electrico", true);
        Incidente incidente3 = new Incidente("3", "DESCONOCIDO", "Incidente sin categoria clara", false);
